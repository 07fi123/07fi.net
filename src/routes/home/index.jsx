...
const Home = () => (
  <div class={style.home + " " + style.me}>
    ...
    <p>
      I build excellent software for organizations and individuals.
      <br /> What could I build <span class={style.forYou}>for you?</span>
    </p>
    <p>
      <a class={style.book} href="/contact">
        Get in touch
      </a>
    </p>
  </div>
