        ...
        <div class={style.columns}>
          <div class={style.column}>
            <h3>
              ...
              {!email && (
                <button
                  class={style.notRobot}
                  onClick={(e) => showEmail(!email)}
                >
                  after I check that you're not a robot 🤖
                </button>
              )}
              {email && <ShowEmail />}
              or setup a meeting. Click to{" "}
              <a
                class={style.book}
                href="https://book.morgen.so/07fi12392/open-hours"
              >
                book a consultation.
              </a>
            </h3>
...
const ShowEmail = () => {
  return (
    <span>
      {" "}
      to{" "}
      <a class={style.book} href="mailto:contact@07fi.net">
        contact@07fi.net
      </a>{" "}
    </span>
  );
